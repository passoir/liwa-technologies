 ...
 * 
 */
public class ARCCollectionParserCPM extends Thread {
	/**
	...
	public ARCCollectionParserCPM(String args[]) throws UIMAException,
			IOException {
		...
		if (args.length < 1) {
			...
			args[0] = "testarcs";
			//args[0] = "/home/tereza/liwa/ukgov/";
			
		//	args[0] = "/data/iofciu/liwaData/download/2006";
		...
		//System.out.println("data path /data/iofciu/uimatools/TreeTagger");
   ...
   */
	...
	public static void main(String[] args) throws UIMAException, IOException,
		...
		ARCCollectionParserCPM cpm = new ARCCollectionParserCPM(args);
