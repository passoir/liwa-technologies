...
public class SimpleRunCPM extends Thread {
	...
	public SimpleRunCPM(String args[]) throws UIMAException, IOException {
		...
		if (args.length < 5) {
			printUsageMessage();
			args = new String[5];
			args[0] = "desc/FileSystemCollectionReader.xml";
			args[1] = "desc/MarkupOpenNLPAggregatePOSTagger.xml";
			args[2] = "/home/tereza/apache-uima/examples/descriptors/cas_consumer/XmiWriterCasConsumer.xml";
			args[3] = "/home/tereza/expdata/Liwa/newdata";
			args[4] = "/home/tereza/expdata/Liwa/processeddata";
			// System.exit(1);
		}

		String ColectionReaderDesc = args[0];
		String AnnotatorDesc = args[1];
		String CasConsumerDesc = args[2];
		...
		collectionReader.setConfigParameterValue("InputDirectory",
				"/home/tereza/expdata/Liwa/newdata");
