 ...
 * @generated
 */
public class Lemma_Type extends ModifiedToken_Type {
	/** @generated */
	...
	private final FSGenerator fsGenerator = new FSGenerator() {
		public FeatureStructure createFS(int addr, CASImpl cas) {
			if (Lemma_Type.this.useExistingInstance) {
				...
				FeatureStructure fs = Lemma_Type.this.jcas
				...
				return new Lemma(addr, Lemma_Type.this);
		}
	};
	/** @generated */
	...
	public final static boolean featOkTst = JCasRegistry
			.getFeatOkTst("de.tudarmstadt.ukp.dkpro.core.type.Lemma");
	...
	public Lemma_Type(JCas jcas, Type casType) {
		...
		casFeat_value = jcas.getRequiredFeatureDE(casType, "value",
