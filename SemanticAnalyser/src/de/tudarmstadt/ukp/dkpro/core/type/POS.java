...
public class POS extends Annotation {
	...
	/**
	 * getter for PosValue - gets The string representation of POS. Mostly it is
	 * the POS representation of the wrapped POS tagger.
	 * 
	 * @generated
	 */
	public String getPosValue() {
		if (POS_Type.featOkTst
				&& ((POS_Type) jcasType).casFeat_PosValue == null)
			jcasType.jcas.throwFeatMissing("PosValue",
					"de.tudarmstadt.ukp.dkpro.core.type.POS");
		return jcasType.ll_cas.ll_getStringValue(addr,
				((POS_Type) jcasType).casFeatCode_PosValue);
	}

	/**
	 * setter for PosValue - sets The string representation of POS. Mostly it is
	 * the POS representation of the wrapped POS tagger.
	 * 
	 * @generated
	 */
	public void setPosValue(String v) {
		...
		jcasType.ll_cas.ll_setStringValue(addr,
				((POS_Type) jcasType).casFeatCode_PosValue, v);
	}
}
