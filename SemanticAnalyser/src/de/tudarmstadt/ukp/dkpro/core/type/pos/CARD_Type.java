...
/**
 * Cardinal number Updated by JCasGen Tue Dec 01 19:55:13 CET 2009
 * 
 * @generated
 */
public class CARD_Type extends POS_Type {
	...
	private final FSGenerator fsGenerator = new FSGenerator() {
		public FeatureStructure createFS(int addr, CASImpl cas) {
			if (CARD_Type.this.useExistingInstance) {
				...
				return new CARD(addr, CARD_Type.this);
		}
	};
	/** @generated */
	...
	public final static boolean featOkTst = JCasRegistry
			.getFeatOkTst("de.tudarmstadt.ukp.dkpro.core.type.pos.CARD");
