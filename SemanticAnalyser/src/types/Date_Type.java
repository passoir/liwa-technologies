...
public class Date_Type extends Annotation_Type {
	 ...
	 * @modifiable
	 */
	public final static boolean featOkTst = JCasRegistry.getFeatOkTst("types.Date");
	...
	public int getDay(int addr) {
      ...
      jcas.throwFeatMissing("day", "types.Date");
	...
	public int getMonth(int addr) {
      ...
      jcas.throwFeatMissing("month", "types.Date");
	...
	public int getYear(int addr) {
      ...
      jcas.throwFeatMissing("year", "types.Date");
