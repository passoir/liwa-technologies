...
public class Annotation_Type extends org.apache.uima.jcas.tcas.Annotation_Type {
	 ...
	 * @modifiable
	 */
	public final static boolean featOkTst = JCasRegistry.getFeatOkTst("types.Annotation");
	...
	public String getConfidence(int addr) {
      ...
      jcas.throwFeatMissing("confidence", "types.Annotation");
	...
	public String getComponentId(int addr) {
      ...
      jcas.throwFeatMissing("componentId", "types.Annotation");
	...
	public String getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "types.Annotation");
